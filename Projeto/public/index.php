RewriteEngine On #Ativa o módulo de reescrita do Apache (mod_rewrite). Sem isso, nenhuma
regra de reescrita funcionaria. Abaixo, colocaremos as estruturas que queremos que o Apache
acompanhe, ao invés do padrão dele.
